...
def test_validate_non_empty_success():
    validators.validate_non_empty("Hello", "TestField")  # should not raise
...
def test_validate_email_success():
    validators.validate_email("user@example.com")  # should not raise
...
def test_validate_password_strength_success():
    validators.validate_password_strength("Pass123")  # should not raise
...
def test_validate_age_success():
    validators.validate_age(25)  # should not raise
...
def test_validate_role_success():
    for role in validators.VALID_ROLES:
        validators.validate_role(role)  # should not raise
...
def test_validate_region_name_success():
    validators.validate_region_name("Nairobi")  # should not raise
